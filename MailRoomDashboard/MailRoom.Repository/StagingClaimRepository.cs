...
namespace MailRoom.Repository
{
    ...
    public class StagingClaimRepository : RepositoryBase<MailRoomContext>, IStagingClaimRepository
    {
        ...
        public async Task<IList<StagingClaimCms1500>> GetStagingCMSClaimsByReviewerAsync(string reviewerId, int reviewStatus)
        {
            ...
            return await DataContext.StagingclaimCms1500
               ...
               .Where(c => c.ReviewerId == reviewerId && c.ReviewStatus == reviewStatus).ToListAsync<StagingClaimCms1500>();
        }
