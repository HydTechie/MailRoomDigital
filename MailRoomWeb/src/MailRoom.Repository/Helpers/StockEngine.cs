...
namespace MailRoom.Repository.Helpers
{
    ...
    /// </summary>
    public class StagingEngine : IStagingEngine
    {       
        //public async Task<List<Security>> GetSecurityQuotesAsync(params string[] symbols)
        //{
        //    XDocument doc = await CreateXDocumentAsync("https://raw.githubusercontent.com/DanWahlin/MailRoom-ASPCore/master/src/MailRoom/XML/financequotes.xml");
        ...
        //{
        //    XDocument doc = await CreateXDocumentAsync("https://raw.githubusercontent.com/DanWahlin/MailRoom-ASPCore/master/src/MailRoom/XML/marketquotes.xml");
        //    if (symbols.Length > 0) FilterSymbols(doc, symbols);
