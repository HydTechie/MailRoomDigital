...
namespace MailRoom.Controllers
{
 ...
 [Route("[controller]")]
    public class DataServiceController : Controller
    {
        ...
        public DataServiceController(IStagingClaimRepository stagingClaimsRepo
        ...
        {
            DashboardWeek dweek = await _StagingClaimRepository.GetDashboardByWeekAsync("reviewerid1");
            if (dweek == null)
            {
                return NotFound();
            }
        ...
        private static Chart GenerateBarChart(List<string> xData, List<double> yData)
        {
            ...
            // X-Axis 
            data.Labels = xData; // new List<string>() { "Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday" };

            BarDataset dataset = new BarDataset()
            {
                Label = "# of Claims",
                Data = yData, //new List<double>() { 12, 19, 3, 5, 2, 3, 8 },
