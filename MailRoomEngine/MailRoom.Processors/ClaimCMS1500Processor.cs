...
using MailRoom.Processors.Constant;
...
namespace MailRoom.Processors
{
    ...
    public class ClaimCMS1500Processor : IProcessor
    {
        ...
        public ClaimCMS1500Processor(Cms15001 claim, EngineConfiguration engineConfig)
        {
            row = claim;
            engConfig = engineConfig;
        }

        public ClaimCMS1500Processor(Cms15001 claim, int confidenceThreshold)
        {
            row = claim;
            engConfig = new EngineConfiguration(confidenceThreshold);
        }
